...
public class ActivitiRestServicesApplication extends ActivitiRestApplication {
	...
	protected RestResponseFactoryCBS restResponseFactoryCBS;
  ...
  public void setRestResponseFactoryCBS(RestResponseFactoryCBS restResponseFactoryCBS) {
    this.restResponseFactoryCBS = restResponseFactoryCBS;
  }
  
  public RestResponseFactoryCBS getRestResponseFactoryCBS() {
    if(restResponseFactoryCBS == null) {
      restResponseFactoryCBS = new RestResponseFactoryCBS();
    }
    return restResponseFactoryCBS;
  }

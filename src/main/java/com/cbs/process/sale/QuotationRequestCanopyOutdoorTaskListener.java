...
/**
 * Centralized Task initial setup for all tasks in "quotation_request process canopy outdoor".
...
public class QuotationRequestCanopyOutdoorTaskListener implements TaskListener {
